                ...
                <div className="grid lg:grid-cols-1">
                  ...
                  <div className="bg-gray-50 p-6 rounded-md">
                    <AdSummary 
                      ...
                      adAccountName={targetingData.adAccountId === "account_1" ? "DraperAds Marketing (ID: 1078354229)" : targetingData.adAccountId === "account_2" ? "Creative Solutions (ID: 897216453)" : `${targetingData.adAccountId}`}
              ...
              <div className="mt-6">
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-center">
                  ...
                  <Button
                    ...
                    className={`w-full sm:w-auto py-2.5 text-white font-medium text-base ${!isMetaConnected ? 'bg-gray-400 hover:bg-gray-400 cursor-not-allowed' : 'bg-[#f6242f] hover:opacity-90'}`}
                  >
                    ...
                    ) : !isMetaConnected ? "Connect Meta to Publish" : "Publish to Meta"}
                  </Button>
                </div>
              </div>
            </div>
