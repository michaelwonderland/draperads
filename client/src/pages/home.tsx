    ...
    <div className="container mx-auto px-4 py-6">
      <div className="mb-8">
        <div className="bg-white rounded-lg shadow-sm p-8 text-center">
          ...
          <Link href="/ad-creator">
            <Button className="bg-[#f6242f] hover:bg-[#D4AF37] hover:text-white text-white px-6 py-2 text-lg">
              Create An Ad
            </Button>
          </Link>
        </div>
      ...
      <div className="mb-12 bg-white rounded-lg shadow-sm p-6 border border-[#E4E6EB]">
        ...
        <div className="flex justify-center">
          <Link href="/ad-creator">
            <Button className="bg-[#f6242f] hover:bg-[#D4AF37] hover:text-white text-white">
              Try DraperAds Now
            </Button>
          </Link>
        </div>
